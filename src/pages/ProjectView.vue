    ...
    <Page>
        ...
        <TabView :selectedIndex="selectedIndex">
            ...
            <TabViewItem title="Podsumowanie">
                <ScrollView>
                    <StackLayout>
                        ...
                        <StackLayout class="projectPriorityContainer"
                            v-bind:class="{ lowPriority: project.priority == '1', mediumPriority: project.priority == '2', highPriority: project.priority
				== '3' }">
                        ...
                        <StackLayout class="projectDescriptionContainer">
                            ...
                            <Label :text="project.description"
                                class="projectDescription" textWrap="true" />
                        </StackLayout>
                        ...
                        <StackLayout class="projectChangesContainer">
                            <Label text="HISTORIA ZMIAN"
                                class="projectHeader" />
                            <StackLayout v-for="change in project.changes"
                                @tap="onChangeTap" class="changeCard">
                                <Label :text="change.name" class="changeText"
                                    textWrap="true" />
            ...
            <TabViewItem title="Zadania">
                <ScrollView>
                    <StackLayout>
                        <StackLayout v-for="taskGroup in project.taskGroups"
                            class="projectTasksContainer">
                            <Label :text="taskGroup.name"
                                class="projectHeader" />
                            <StackLayout v-for="task in taskGroup.tasks"
                                class="taskCard">
                                <Label :text="task.name" class="taskText"
                                    textWrap="true" />
                                <WrapLayout orientation="horizontal"
                                    horizontalAlignment="right">
                                    <StackLayout v-for="user in task.users">
                                        <Image :src="user.userImageSrc"
                                            class="userTaskPhoto"
                                            stretch="aspectFill" />
                                    </StackLayout>
                                </WrapLayout>
                ...
                <FlexboxLayout flexDirection="column">
                    <ScrollView height="90%">
                        <StackLayout class="chatWindow">
                            <StackLayout
                                ...
                                v-bind:class="{ chatMessageOutContainer: message.userID == '1' }">
                                <Label :text="message.userName"
                                    class="messageUsername" />
                                <StackLayout class="chatMessageIn"
                                    v-bind:class="{ chatMessageOut: message.userID == '1' }"
                                    orientation="horizontal">
                                    <Image :src="message.userImageSrc"
                                        class="userPhoto"
                                        stretch="aspectFill" />
                    ...
                    <StackLayout orientation="horizontal" height="10%">
                        <TextField v-model="textFieldValue"
                            hint="Napisz wiadomość" width="65%"
                            class="chatTextField" />
                        <Button text="Wyślij" @tap="onButtonTap" width="25%"
...
<script>
    export default {
        ...
        data() {
            return {
                project: {
                    imageSrc: "https://www.streamscheme.com/wp-content/uploads/2020/07/kekw-emote.jpg",
                    ...
                    changes: [{
                            name: "Lorem ipsum dolor sit amet coś tam coś tam bla bla blablabla bla bla sa dh gf sa f qhb fuf ds sd kjsd ds age kjr gd kdj fg sdfg et 345r5w",
                            date: "12.01.2021"
                        },
                        {
                    ...
                    taskGroups: [{
                            ...
                            tasks: [{
                                    ...
                                    users: [{
                                        userImageSrc: "https://www.pngitem.com/pimgs/m/622-6225086_dank-meme-laser-laughing-emoji-crying-emoji-riendo.png"
                                    }]
                                },
                                {
                                    name: "Laravel",
                        ...
                        },
                        {
                            ...
                            tasks: [{
                                    ...
                                    users: [{
                                        ...
                                        {
                                            userImageSrc: "https://i.pinimg.com/originals/5c/99/6e/5c996e6663a3c2ef1b92ad9ef13ffef7.png"
                                        }
                                    ]
                                },
                                {
                                ...
                                {
                                    name: "Lorem ipsum dolor trololololor lololololo lo o lo l ol oretkwghs dg jlsdgh df gd sdlg",
                                    users: [{
                                        userImageSrc: "https://www.pngitem.com/pimgs/m/622-6225086_dank-meme-laser-laughing-emoji-crying-emoji-riendo.png"
                                    }]
                                }
                    ...
                    chatMessages: [{
                        ...
                        {
                            userID: "2",
                            userImageSrc: "https://pbs.twimg.com/profile_images/1318131574857150464/2rhjXSCr_400x400.jpg",
                            userName: "twoj stary",
                            text: "heuehuehheuueheueheheuehuehheuueheueheuheuehuehheuueheueheuheuehuehheuueheueheuuheuehuehheuueheueheuheuehuehheuueheueheu"
                        },
                        {
                            userID: "2",
                            userImageSrc: "https://pbs.twimg.com/profile_images/1318131574857150464/2rhjXSCr_400x400.jpg",
                            userName: "twoj stary",
                            text: "hokus pokus, czary mary, twoja stara to twoj stary... wait a minute"
                        },
                        {
                            userID: "1",
                            userImageSrc: "https://www.pngitem.com/pimgs/m/622-6225086_dank-meme-laser-laughing-emoji-crying-emoji-riendo.png",
                        ...
                        {
                            userID: "3",
                            userImageSrc: "https://fiverr-res.cloudinary.com/images/q_auto,f_auto/gigs/38577360/original/fe4a778310a86b3072d4f2d2c0b1ee38a4e2a3e7/do-a-spoderman-meme-avatar-of-you.png",
                            userName: "spoderman",
