<template>
    <ScrollView>
        <StackLayout class="editProjectModal">
            ...
            <Button text="AKTUALIZUJ PROJEKT" @tap="editProject"
                class="editProjectConfirmButton" />

            <Button text="USUŃ PROJEKT" @tap="editProject"
